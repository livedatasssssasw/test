(function () {
  ...
  BitKeepInvoke.prototype._init = function () {
    if (document.addEventListener) {
      document.addEventListener(
        'DOMContentLoaded',
        this.bind(this._initCallback, this),
        true
      );
   ...
   * @param {*} t 回调函数
   */
  BitKeepInvoke.prototype.selectCoin = function (e, t) {
    this.jHost(['selectCoin', e ? e.toLowerCase() : ''], function (e, a) {
      e ? t && t(e) : ((a = JSON.parse(a)), t && t(e, a));
    });
  };
  ...
  BitKeepInvoke.prototype.shareUrl = function (
    title,
    description,
    url,
    thumbnail,
  ...
  BitKeepInvoke.prototype.selecterAddress = function (callback) {
    this.jHost(['selecterAddress'], function (err, result) {
      callback && callback(err, result);
    });
  };

  BitKeepInvoke.prototype.setTitle = function (e) {
    this.jHost(['setTitle', e]);
  };
  /**
   *
   * @param {*} e  callback
   * @param {*} t  链ID
   */
  BitKeepInvoke.prototype.switchWallet = function (e, t) {
    this.jHost(t ? ['switchWallet', t] : ['switchWallet'], function (t, a) {
      t ? e && e(t) : ((a = JSON.parse(a)), e && e(t, a));
    });
  };
